...
i18n.dayNames = ["Ned", "Pon", "Uto", "Sri", "Čet", "Pet", "Sub", "Nedjelja", "Ponedjeljak", "Utorak", "Srijeda", "Četvrtak", "Petak", "Subota"];
    ...
    <>
      <div className="card-container">
        ...
        <div className="card-body">
          ...
          <button className="workshop-buy-button" onClick={(e) => AddToBasket(workshop)}>
            Dodaj u košaricu
          </button>
        </div>
      </div>
