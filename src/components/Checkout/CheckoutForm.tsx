  ...
  return (
    <>
      <form autoComplete="off" className="login-form" onSubmit={(event) => HandleSubmit(event)}>
        ...
        <input className="checkout-form-input" name="name" placeholder="Type your first name here" type="text" onChange={(event) => HandleChange(event)}></input>
        <p className={`helper-text ${errors.nameError ? "active" : null}`}>{errors.name}</p>
        <label className="checkout-form-label">Last name:</label>
        <input className="checkout-form-input" name="surname" placeholder="Type your last name here" type="text" onChange={(event) => HandleChange(event)}></input>
        ...
        <input className="checkout-form-input" name="email" placeholder="Type your email address here" type="email" onChange={(event) => HandleChange(event)}></input>
        ...
        <div className="checkout-form-date-gender">
          <div className="checkout-form-date">
            ...
            <input name="dateOfBirth" placeholder="DD.MM.YYYY" type="date" className="checkout-form-input" onChange={(event) => HandleChange(event)}></input>
        ...
        <input className="checkout-form-input" name="address" placeholder="Type your address address here" type="text" onChange={(event) => HandleChange(event)}></input>
        ...
        <input className="checkout-form-input" name="ZIPcode" placeholder="eg. 21310" type="text" onChange={(event) => HandleChange(event)}></input>
        <p className={`helper-text ${errors.ZIPcodeError ? "active" : null}`}>{errors.ZIPcode}</p>
        <label className="checkout-form-label">
          <input className="checkbox-input" name="I_agree" placeholder="eg. 21310" type="checkbox" onChange={(event) => Agree()}></input>I agree
        </label>
        <button type={active ? "submit" : "button"} className={`checkout-button ${active === true ? "active" : null}`}>
          Checkout
        </button>
      </form>
